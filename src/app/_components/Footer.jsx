            ...
            <div className="lg:col-span-1">
              <div className="mb-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-tertiary">Pen Tech Solutions</h3>
                </div>
                {/* <p className="text-tertiary/80 leading-relaxed mb-6">
                  Transforming businesses with innovative technology solutions. We deliver cutting-edge web
                  applications, mobile apps, and cloud services that drive growth.
                </p> */}
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 text-tertiary/80">
                    ...
                    <span className="text-sm">+92 321 8815888</span>
                  </div>
                  <div className="flex items-center gap-3 text-tertiary/80">
                    <Mail className="w-4 h-4 text-secondary" />
                    <span className="text-sm">info@pentechsolution.com</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="border-t border-tertiary/20 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="text-tertiary/70 text-sm">
              © {new Date().getFullYear()} Pen Tech Solutions. All rights reserved. Built with passion and innovation.
            </div>
